define(['exports'], (function (exports) { 'use strict';
    ...
    */
     ...
     * @private
     */
    const validMethods$1 = ['DELETE', 'GET', 'HEAD', 'PATCH', 'POST', 'PUT'];
      ...
      constructor(match, handler, method = defaultMethod$1) {
        {
          ...
          if (method) {
            finalAssertExports.isOneOf(method, validMethods$1, {
              paramName: 'method'
            });
          }
        }
    ...
    */
     ...
     */
    class RegExpRoute$1 extends Route$1 {
      /**
    ...
    */
    ...
    function registerRoute$1(capture, handler, method) {
      ...
      const defaultRouter = getOrCreateDefaultRouter$1();
